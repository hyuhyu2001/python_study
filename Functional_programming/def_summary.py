...
函数可以返回多个值return x,y ,同时获得返回值 x, y = move(100, 100, 60, math.pi / 6)，但其实是假象，多值时返回的是一个元组，
...
tupleVarArgs('abc', 123, 'xyz',
             456.789)  # 结果： formal arg 1: abc  formal arg 2: 123  another arg: xyz   another arg: 456.789
